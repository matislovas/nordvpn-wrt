...
return view.extend({
	load: function() {
		return fs.exec('/sbin/ifconfig').then(function(res) {
			...
			var interfaces = res.stdout.match(/nordlynx|nordtun/g);
	...
	render: function(data) {
		var title = E('h2', {class: 'content'}, _('NordVPN'));
		var desc = E('div', {class: 'cbi-map-descr'}, _('NordVPN is best online VPN service for speed and security.'));
